...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Сен 23 2019 г., 09:31
...
(6, '2019-09-19 01:10:39', '2019-09-19 01:10:29', '2019-09-19 01:10:39', 'qwe', '1500', '10', '10');
...
(18, 'accepted_invite_xims_amount', '', '24', '2019-09-12 01:30:28', '2019-09-12 02:25:15'),
(19, 'professionals_radius', '', '100', '2019-09-12 01:30:28', '2019-09-12 02:25:15');
...
(16, 'Notifications', 'notifications', 'fa fa-bell-o', 'module', 0, 5, '2019-07-23 00:28:27', '2019-09-14 01:40:43'),
...
(20, 'Buy_Credits', 'buy_credits', 'fa fa-credit-card', 'module', 0, 6, '2019-07-30 09:02:26', '2019-09-14 01:40:43'),
(22, 'Meetup_reasons', 'meetup_reasons', 'fa fa-th-list', 'module', 1, 8, '2019-09-12 02:07:16', '2019-09-22 01:16:44'),
(23, 'Countries list', 'countries', 'fa-cubes', 'custom', 1, 6, '2019-09-12 02:08:39', '2019-09-12 02:09:14'),
(24, 'Promos', 'promos', 'fa fa-bullhorn', 'module', 0, 4, '2019-09-14 01:17:15', '2019-09-14 01:40:43'),
(25, 'Meetups', 'meetups', 'fa fa-maxcdn', 'module', 1, 7, '2019-09-22 01:16:30', '2019-09-22 01:16:44');
...
(5, NULL, '2019-09-18 02:05:49', '2019-09-18 02:05:49', '48.93', '24.7', 'Ivano-Frankivs\'k', 'Ukraine', '{\"address_components\":[{\"long_name\":\"12\",\"short_name\":\"12\",\"types\":[\"street_number\"]},{\"long_name\":\"Vulytsya Karpat\\u00b7s\\u02b9ka\",\"short_name\":\"Vulytsya Karpat\\u00b7s\\u02b9ka\",\"types\":[\"route\"]},{\"long_name\":\"Ivano-Frankivs\'k\",\"short_name\":\"Ivano-Frankivs\'k\",\"types\":[\"locality\",\"political\"]},{\"long_name\":\"Ivano-Frankivs\'ka city council\",\"short_name\":\"Ivano-Frankivs\'ka city council\",\"types\":[\"administrative_area_level_3\",\"political\"]},{\"long_name\":\"Ivano-Frankivs\'ka oblast\",\"short_name\":\"Ivano-Frankivs\'ka oblast\",\"types\":[\"administrative_area_level_1\",\"political\"]},{\"long_name\":\"Ukraine\",\"short_name\":\"UA\",\"types\":[\"country\",\"political\"]},{\"long_name\":\"76000\",\"short_name\":\"76000\",\"types\":[\"postal_code\"]}],\"formatted_address\":\"Vulytsya Karpat\\u00b7s\\u02b9ka, 12, Ivano-Frankivs\'k, Ivano-Frankivs\'ka oblast, Ukraine, 76000\",\"geometry\":{\"location\":{\"lat\":48.9298845,\"lng\":24.6995241},\"location_type\":\"ROOFTOP\",\"viewport\":{\"northeast\":{\"lat\":48.9312334802915,\"lng\":24.7008730802915},\"southwest\":{\"lat\":48.9285355197085,\"lng\":24.69817511970849}}},\"place_id\":\"ChIJ70TNp4rBMEcRGd666As5ImA\",\"plus_code\":{\"compound_code\":\"WMHX+XR Ivano-Frankivsk, Ivano-Frankivsk Oblast, Ukraine\",\"global_code\":\"8GW6WMHX+XR\"},\"types\":[\"establishment\",\"gym\",\"health\",\"point_of_interest\"]}', 'UA');

-- --------------------------------------------------------

--
-- Структура таблицы `meetups`
--
...
CREATE TABLE `meetups` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `unique_code` varchar(256) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `user_id_inviting` varchar(256) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `user_id_invited` varchar(256) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `reason` varchar(256) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `inviting_date` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `invited_date` datetime DEFAULT NULL,
  `status` varchar(256) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Дамп данных таблицы `meetups`
--

INSERT INTO `meetups` (`id`, `deleted_at`, `created_at`, `updated_at`, `unique_code`, `user_id_inviting`, `user_id_invited`, `reason`, `inviting_date`, `invited_date`, `status`) VALUES
(4, NULL, '2019-09-23 00:41:36', '2019-09-23 00:41:36', '5d883ef01847d', '16', '9', '4', '2019-09-23 00:41:36', NULL, '1');
...
(23, 'Promos', 'Promos', 'promos', 'title', 'Promo', 'PromosController', 'fa-bullhorn', 1, '2019-09-14 01:14:04', '2019-09-14 01:17:15'),
(24, 'Meetups', 'Meetups', 'meetups', 'unique_code', 'Meetup', 'MeetupsController', 'fa-maxcdn', 1, '2019-09-22 01:07:23', '2019-09-22 01:16:30');
...
(155, 'title', 'Title', 23, 22, 0, '', 0, 256, 1, '', 0, '2019-09-14 01:15:20', '2019-09-14 01:15:20'),
(156, 'image', 'Image', 23, 12, 0, '', 0, 0, 1, '', 0, '2019-09-14 01:15:35', '2019-09-14 01:15:35'),
(157, 'tags', 'Tags', 23, 20, 0, '', 0, 256, 1, 'null', 0, '2019-09-14 01:16:49', '2019-09-14 01:16:49'),
(158, 'status', 'Status', 23, 2, 0, '1', 0, 0, 1, '', 0, '2019-09-14 01:17:07', '2019-09-14 01:17:07'),
(159, 'unique_code', 'Unique Code', 24, 22, 1, '', 0, 256, 1, '', 0, '2019-09-22 01:09:17', '2019-09-22 01:09:17'),
(160, 'user_id_inviting', 'Inviting User', 24, 22, 0, '', 0, 256, 1, '', 0, '2019-09-22 01:10:40', '2019-09-22 01:11:23'),
(161, 'user_id_invited', 'Invited User', 24, 22, 0, '', 0, 256, 1, '', 0, '2019-09-22 01:11:13', '2019-09-22 01:11:13'),
(162, 'reason', 'Meetup Reason', 24, 22, 0, '', 0, 256, 1, '', 0, '2019-09-22 01:12:04', '2019-09-22 01:12:04'),
(163, 'inviting_date', 'Inviting Date', 24, 5, 0, '', 0, 0, 0, '', 0, '2019-09-22 01:13:13', '2019-09-22 01:13:13'),
(164, 'invited_date', 'Accept/Declined Date', 24, 5, 0, '', 0, 0, 0, '', 0, '2019-09-22 01:13:46', '2019-09-22 01:13:46'),
(165, 'status', 'Status', 24, 22, 0, '', 0, 256, 0, '', 0, '2019-09-22 01:15:55', '2019-09-22 01:15:55');
...
INSERT INTO `promos` (`id`, `deleted_at`, `created_at`, `updated_at`, `title`, `image`, `tags`, `status`) VALUES
(1, NULL, '2019-09-14 01:17:43', '2019-09-14 01:28:43', 'test', 0, '[\"asd\",\"sad\",\"newsy tonight\"]', 1),
(2, NULL, '2019-09-19 14:51:20', '2019-09-19 14:51:20', 'test2', 100, '[\"t2\"]', 1),
(3, NULL, '2019-09-19 14:51:35', '2019-09-19 15:01:10', 'test3', 94, '[\"qwe\"]', 1),
(4, NULL, '2019-09-19 15:01:41', '2019-09-19 15:01:41', 'test', 61, '[\"\",\"test\"]', 1);
...
(22, 1, 23, 1, 1, 1, 1, '2019-09-14 01:17:15', '2019-09-14 01:17:15'),
(23, 1, 24, 1, 1, 1, 1, '2019-09-22 01:16:30', '2019-09-22 01:16:30');
...
(155, 1, 155, 'write', '2019-09-14 01:15:21', '2019-09-14 01:15:21'),
(156, 1, 156, 'write', '2019-09-14 01:15:35', '2019-09-14 01:15:35'),
(157, 1, 157, 'write', '2019-09-14 01:16:50', '2019-09-14 01:16:50'),
(158, 1, 158, 'write', '2019-09-14 01:17:08', '2019-09-14 01:17:08'),
(159, 1, 159, 'write', '2019-09-22 01:09:18', '2019-09-22 01:09:18'),
(160, 1, 160, 'write', '2019-09-22 01:10:41', '2019-09-22 01:10:41'),
(161, 1, 161, 'write', '2019-09-22 01:11:14', '2019-09-22 01:11:14'),
(162, 1, 162, 'write', '2019-09-22 01:12:05', '2019-09-22 01:12:05'),
(163, 1, 163, 'write', '2019-09-22 01:13:13', '2019-09-22 01:13:13'),
(164, 1, 164, 'write', '2019-09-22 01:13:46', '2019-09-22 01:13:46'),
(165, 1, 165, 'write', '2019-09-22 01:15:56', '2019-09-22 01:15:56');
...
(101, '0301', 'D:\\PROGRAMS\\OpenServer\\domains\\impresso.me\\storage\\uploads\\2019-09-21-092939-0301.jpg', 'jpg', '', 16, 'cyzvg2psnaj8mnu4kdot', 0, NULL, '2019-09-21 06:29:39', '2019-09-21 06:29:40');
...
(1, 'Super Admin', 'admin@mail.com', '$2y$10$4arodD96t8qQfS5kKEjqkuzEe5sgEaDa3SicF2P1wfduF3F4njA3u', 1, 'JL1dG58oFXRMjW6Zni7eoujiwWUh8yFa0MKVJNqYlrc2oDNTxQgDxP0QHCij', NULL, '2019-07-02 10:35:31', '2019-09-22 01:53:28', 1, '', '', 0, 0, 0, 'Ivano-Frankivs\'k, Ukraine', '', '', '', '', '', '', 0, '24.7', '48.93', '', '', '', '', '', '', '0.000', '0', '', '0', ''),
...
(9, 'Ivan', 'admintest7@mail.com', '$2y$10$t5WEFw62ujhuQaUojcp2XOF9SdqriQY08l3yT2DKdND300id7lNQK', 3, 'dvTnJqICcYwCgWOLJcnE4Jrtr9f7D0wz8LLTbHfgGUQg9pfDEkKzS2qYKFJy', NULL, '2019-07-03 17:35:11', '2019-09-23 01:45:27', 1, 'PHP Developer', 'NPG', 38, 27, 28, 'Ivano-Frankivs\'k, Ukraine', 'qwe\nasdasd\nqwe', 'w\nwe\nwewe', 'test', '123345', 'site', '5d1d117f5e54b', 1, '24.7', '48.93', 'Precarpathian University', 'test', 'Full Name', 'City', 'address', 'address2', '169.220', '0', '2019-09-23 04:45:27', '0', ''),
...
(16, 'Ivan Developer', 'admintest23@mail.com', '$2y$10$t5WEFw62ujhuQaUojcp2XOF9SdqriQY08l3yT2DKdND300id7lNQK', 3, 'T1CrhUbb6auFtXItc4KqbGmJ5FcKc7B6mpntlI5JzZkyPialzbwzj8h1X7gw', NULL, '2019-07-26 07:14:02', '2019-09-23 01:22:23', 1, 'Php', 'NPG Studio', 101, 99, 100, 'Ivano-Frankivs\'k, Ukraine', '1\n2\n3', '00\n\n', 'qwe IMPRESSIVE BIO', '+32 123 123 22', 'site', '5d3ad26a82799', 0, '24.7', '48.93', 'asd', 'cert', 'admintest23 1993 05 02', '123123', '123123', '123123', '6430.000', '1', '2019-09-23 04:22:11', '5', ''),
...
(21, '', 'admintest25@mail.com', '$2y$10$NP5jmD8YQnLuGAR/vE/s1eBdzRLW.BnE3ZdLgvsJ1rDuuIVHIcdOy', 3, 'tNF6uV4Eg7ad6tEpTTobZIJ8b8BeLXEwjXYOOYXVgfCYKNcrK16EoVDGA3cl', NULL, '2019-09-21 13:13:08', '2019-09-21 13:13:09', 0, '', '', 0, 0, 0, '', '', '', '', '', 'site', '5d864c1486c95', 0, '', '', '', '', '', '', '', '', '0.000', '0', '', '0', '');
...
(15, NULL, '2019-09-22 02:30:42', '2019-09-22 02:30:42', '16', 'no_xims', 'You’re out of XIMs', ''),
(16, NULL, '2019-09-22 02:31:00', '2019-09-22 02:31:00', '16', 'no_xims', 'You’re out of XIMs', ''),
(17, NULL, '2019-09-22 02:31:06', '2019-09-22 02:31:06', '16', 'no_xims', 'You’re out of XIMs', ''),
(20, NULL, '2019-09-22 15:20:30', '2019-09-22 15:20:30', '9', 'meetup_wants', '24', '3'),
(21, NULL, '2019-09-23 00:41:36', '2019-09-23 00:41:36', '9', 'meetup_wants', '24', '4');
...
(24, NULL, '2019-09-23 00:41:36', '2019-09-23 00:41:36', 16, '-30.000', 'You have used 30 for inviting Ivan to Meetup.', 'meetup_inviting', '16', '', '4', '', '', '6460', '6430');
...
--
-- AUTO_INCREMENT для таблицы `meetups`
--
ALTER TABLE `meetups`
