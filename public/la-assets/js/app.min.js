...
$(document).ready(function() {
    ...
    $("body").on("click", ".fm_file_sel", function() {
        ...
        if(type == "image") {
            ...
            $hinput.next("a").next(".uploaded_image").find('.uploaded_image_link').remove();
            $hinput.next("a").next(".uploaded_image").append('<div class="uploaded_image_link"><a href="' + bsurl+'/files/'+upload.hash+'/'+upload.name + '" target="_blank">Open file in new window.</a></div>')
        } else if(type == "files") {
            $hinput = $("input[name="+$("#image_selecter_origin").val()+"]");
