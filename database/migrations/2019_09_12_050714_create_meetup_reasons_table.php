...
class CreateMeetupReasonsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("Meetup_reasons", 'meetup_reasons', 'title', 'fa-th-list', [
    ...
    {
        if (Schema::hasTable('meetup_reasons')) {
            Schema::drop('meetup_reasons');
        }
    }
}
