...
class CreateUserEducationsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("User_educations", 'user_educations', 'title', 'fa-archive', [
            ["title", "Title", "TextField", false, "", 0, 256, true],
            ["speciality", "Speciality / Domain", "TextField", false, "", 0, 256, false],
    ...
    {
        if (Schema::hasTable('user_educations')) {
