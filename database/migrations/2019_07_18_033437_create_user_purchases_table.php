...
class CreateUserPurchasesTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("User_purchases", 'user_purchases', 'purchase_amount', 'fa-cc-stripe', [
            ["user_id", "User", "Dropdown", false, "", 0, 0, true, "@users"],
            ["purchase_amount", "Purchase Amount", "TextField", false, "", 0, 256, true],
            ["payment_id", "Payment ID", "TextField", false, "", 0, 256, false],
            ["status", "Status", "TextField", false, "", 0, 256, true],
        ]);
