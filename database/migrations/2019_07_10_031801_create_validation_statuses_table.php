...
class CreateValidationStatusesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("Validation_statuses", 'validation_statuses', 'title', 'fa-asterisk', [
    ...
    public function down()
    {
        if (Schema::hasTable('validation_statuses')) {
            Schema::drop('validation_statuses');
        }
    }
}
