    ...
    <div class="main">
        ...
        <main>
            <div class="user">
                ...
                <div class="job-title">
                    <input class="style-input-text style-input-text_right" type="text" value="@if($userData->job_title){{$userData->job_title}}@endif" placeholder="Job title ">
                    <span>at</span>
                    <input class="style-input-text" type="text" value="@if($userData->company_title){{$userData->company_title}}@endif" placeholder="Company">
                </div>
                    ...
                    <ul class="list-type-circle">
                        ...
                        <li>
                            <input class="style-input-text" type="text" value="@if($userData->job_title){{$userData->job_title}}@else{{''}}@endif"
                                   placeholder="Add job title / status">
                        </li>
                        <li>
                                ...
                                @if($skill)
                                    <li>
                                        <input class="style-input-text" type="text" value="{{$skill}}"
                                               placeholder="Add skill / interest">
                                    </li>
                                    @php
                                        $topSkillIteration++;
                                    @endphp
                ...
                --}}
                <button type="button" id="save" style="display: block;" class="btn btn-violet btn-save">Save</button>
            </div>
        </main>
