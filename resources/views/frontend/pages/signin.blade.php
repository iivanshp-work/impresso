    ...
    <main class="main">
        <div class="login text-center">
            ...
            <form id="signin_form" class="form" method="post" action="{{url('/sign-in')}}">
                ...
                <div class="form__btn">
                    @if (1 || in_array(app('request')->ip(), ["127.0.0.1", "146.120.169.6", "31.148.253.42", "213.55.220.15", "103.117.20.11", "10.11.0.236", "93.175.195.69"]))
                        {{--<a class="btn btn-social btn-social_instagram"><img src="{{ asset('img/icons/instagram.svg')}}"
                                                                                 alt="Instagram"> Instagram</a>--}}
                        <a href="{{url('/sign-in/linkedin')}}" class="btn btn-social btn-social_linkedin"><img src="{{ asset('img/icons/linkedin.svg')}}" alt="LinkedIn">
                            LinkedIn</a>
                        <a href="{{url('/sign-in/facebook')}}" class="btn btn-social btn-social_facebook"><img src="{{ asset('img/icons/facebook.svg')}}" alt="Facebook">
                            Facebook</a>
