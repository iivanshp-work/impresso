...
@section("contentheader_title", "User certifications")
@section("contentheader_description", "User certifications listing")
@section("section", "User certifications")
@section("sub_section", "Listing")
@section("htmlheader_title", "User certifications Listing")
...
$(function () {
	$("#example1").DataTable({
		processing: true,
        serverSide: true,
        ajax: "{{ url(config('laraadmin.adminRoute') . '/user_certification_dt_ajax') }}",
		language: {
			lengthMenu: "_MENU_",
			search: "_INPUT_",
