...
@section("contentheader_title", "User Educations")
@section("contentheader_description", "User Educations listing")
@section("section", "User Educations")
@section("sub_section", "Listing")
@section("htmlheader_title", "User Educations Listing")
...
$(function () {
	$("#example1").DataTable({
		processing: true,
        serverSide: true,
        ajax: "{{ url(config('laraadmin.adminRoute') . '/user_education_dt_ajax') }}",
		language: {
			lengthMenu: "_MENU_",
			search: "_INPUT_",
