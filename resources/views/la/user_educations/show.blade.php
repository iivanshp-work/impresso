...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $user_education->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("User_Educations", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/user_educations/'.$user_education->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("User_Educations", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.user_educations.destroy', $user_education->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/user_educations') }}" data-toggle="tooltip" data-placement="right" title="Back to User Educations"><i class="fa fa-chevron-left"></i></a></li>
