	...
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $user_transaction->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("User_Transactions", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/user_transactions/'.$user_transaction->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("User_Transactions", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.user_transactions.destroy', $user_transaction->id], 'method' => 'delete', 'style'=>'display:inline']) }}
