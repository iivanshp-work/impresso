...
@section("contentheader_title", "User Transactions")
@section("contentheader_description", "User Transactions listing")
@section("section", "User Transactions")
@section("sub_section", "Listing")
@section("htmlheader_title", "User Transactions Listing")
...
$(function () {
	$("#example1").DataTable({
		processing: true,
        serverSide: true,
        ajax: "{{ url(config('laraadmin.adminRoute') . '/user_transaction_dt_ajax') }}",
		language: {
			lengthMenu: "_MENU_",
			search: "_INPUT_",
