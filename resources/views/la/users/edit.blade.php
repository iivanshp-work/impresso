            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    ...
                    <div class="form-group">
                        ...
                        <button type="button" class="btn bnt-small btn-github margin-r-5 pull-right"><a style="color: #fff" href="{{ url(config('laraadmin.adminRoute') . '/users_notifications?selected_user_id=' . $user->id) }}"><i class="fa fa fa-bell-o margin-r-5"></i> Notifications</a></button>
                        <button type="button" class="btn bnt-small btn-success margin-r-5 pull-right"><a style="color: #fff" href="{{ url(config('laraadmin.adminRoute') . '/user_transactions?selected_user_id=' . $user->id) }}"><i class="fa fa fa-money margin-r-5"></i> Transactions</a></button>
                        <button type="button" class="btn bnt-small btn-pinterest margin-r-5 pull-right"><a style="color: #fff" href="{{ url(config('laraadmin.adminRoute') . '/user_purchases?selected_user_id=' . $user->id) }}"><i class="fa fa fa-cc-stripe margin-r-5"></i> Purchases</a></button>
                        <button type="button" class="btn bnt-small btn-yahoo margin-r-5 pull-right"><a style="color: #fff" href="{{ url(config('laraadmin.adminRoute') . '/user_resumes?selected_user_id=' . $user->id) }}"><i class="fa fa fa-columns margin-r-5"></i> Resume/CV</a></button>
                        <button type="button" class="btn bnt-small btn-primary margin-r-5 pull-right"><a style="color: #fff" href="{{ url(config('laraadmin.adminRoute') . '/user_certifications?selected_user_id=' . $user->id) }}"><i class="fa fa fa-certificate margin-r-5"></i> Certifications</a></button>
                        <button type="button" class="btn bnt-small btn-bitbucket margin-r-5 pull-right"><a style="color: #fff" href="{{ url(config('laraadmin.adminRoute') . '/user_educations?selected_user_id=' . $user->id) }}"><i class="fa fa fa-archive margin-r-5"></i> Educations</a></button>
                        <button type="button" class="btn bnt-smallbtn-default margin-r-5 "><a href="{{ url(config('laraadmin.adminRoute') . '/users') }}">Cancel</a></button>
                    </div>
