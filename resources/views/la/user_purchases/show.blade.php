...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $user_purchase->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("User_Purchases", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/user_purchases/'.$user_purchase->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("User_Purchases", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.user_purchases.destroy', $user_purchase->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/user_purchases') }}" data-toggle="tooltip" data-placement="right" title="Back to User Purchases"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'purchase_amount')
						@la_display($module, 'payment_id')
